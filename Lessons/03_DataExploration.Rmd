...
2. Type `install.packages("packagename")` into your R chunk or console. It will then appear in your packages list. You only need to do this once. (nice to have this in code you may share)
...
#doing this in console and typing read.csv(. ___) allows you to navigate through your local storage
