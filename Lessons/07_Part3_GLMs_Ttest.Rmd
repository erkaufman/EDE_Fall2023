...
- can be run using a linear model framework
...
For example, we might ask ourselves (from the EPA air quality processed dataset): 
Are Ozone levels different between 2018 and 2019? (do these two samples have the same or different means?)
...
- you can also run two sample t test as an lm function
