...
> Answer: freqeuncy of flood events, gauge height and discharge relationships, differences in approved v provisional datasets


How can multiple options for data exploration inform our understanding of our data?

> Answer: understand different trends, can look at one time or across a range of dates to see if things have changed with time (can relate that to land management)
...
> Answer: higher dischrage w higher gage height, wider range of approved data
