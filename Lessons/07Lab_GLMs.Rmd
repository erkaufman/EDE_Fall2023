...
Ozone.plot <- ggplot(EPAair, 
  ...
  labs( x= "Ozone AQI value",
        y = "Density")
  #geom_vline(color = "#238b45", lty = 2, size = 0.9) +
print(Ozone.plot)

#Exercise 2: 
Ozone.box <- ggplot(EPAair, aes(x= as.factor(Year),
                    y = Ozone))+
  geom_boxplot()+
...
library(corrplot)
library(dplyr)
EPAair.subset <- #selecting only columns from mean lat to ozone, smaller dataset
  EPAair %>% 
