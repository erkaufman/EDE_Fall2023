...
#include= FALSE to remove this code from the final knit pdf 
...
The raw dataset has `r nrow(nutrient_data_raw)` rows and `r ncol(nutrient_data_raw)` columns. #doing r code within markdown
