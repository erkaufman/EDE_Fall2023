...
# dplyr filtering
NTL.phys.data.surface <- filter(NTL.phys.data, depth == 0) #== because it is this value
...
NTL.phys.data.Tuesday.90.99 <- filter(NTL.phys.data, year4 %in% c(1990:1999), lakename %in% c("Tuesday Lake"))
...
# through 1999 only for July, you can create a month column, or before your filter you can convert to a month

NTL.phys.data.newprocess <-
  NTL.phys.data %>%
