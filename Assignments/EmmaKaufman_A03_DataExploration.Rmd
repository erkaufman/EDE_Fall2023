...
> Answer: It is a factor class. It is not numeric because it contains categorical data of a threshold concentration. We also read strings in as factors. 
...
Litter$collectDate <- as.Date(Litter$collectDate, format = "%Y-%m-%d") #convert the data within this column to class of dates
