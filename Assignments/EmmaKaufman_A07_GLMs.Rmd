...
> Answer: There is a significant difference in mean temperature among the lakes compared to Central Long lake. The p-value is below 0.05 for each indivudal lake compared to Central Long lake, which means that we can attribute the difference in mean temperature to NOT be attributed to chance, and consider the difference to be significant. 
